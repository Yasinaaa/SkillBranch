...
/*
 * Created by yasina on 2019-12-08
*/
class User private constructor (
    ...
    init {
        ...
        check(!firstName.isBlank()) { "FIrstName mist be not blank!"}
        check(email.isNullOrBlank() || rawPhone.isNullOrBlank()) { "Email or phone mist be not blank!"}
    ...
    //    private fun encrypt(password: String) = password.md5()) // don't do that!!!
    ...
    private fun sendAccessCodeToUser(phone: String, code: String) {
        println(".... sanding access code: $code on $phone")
    }
                ...
                .run {
                    when(size) {
                        ...
                        2 -> first() to last()
                                ...
                                "and last name, current split resurs ${this@fullNameToPair}")
                    }
                }
        }
    }
